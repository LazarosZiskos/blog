  ...
  return (
    <section className="pt-[64px]">
      <div className="flex flex-col text-center border-b pb-[64px]">
        <h1 className="md:text-5xl text-3xl w-full max-w-[900px] mx-auto font-bold leading-[40px] md:leading-[62px] text-[#29294b]">
        ...
        <h2 className="text-[#696981] mt-2.5 tracking-wider leading-[28px] text-[18px]">
